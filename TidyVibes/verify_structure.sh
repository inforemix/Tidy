...
check_file "Services/VisionAPIProtocol.swift"
check_file "Services/APIProviderManager.swift"
check_file "Services/GeminiVisionService.swift"
check_file "Services/GrokVisionService.swift"
